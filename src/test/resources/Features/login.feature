Feature: mercurytours Feature
  ...
  Scenario Outline: Registeration Test Scenario
    ...
    Then user enters mailing address information "<address1>" and "<address2>" and "<city>" and "<state>" and "<postalcode>"
    ...
    Examples: 
      ...
      | firstname | lastname | phone      | email            | address1 | address2 | city | state | postalcode | username | password | confirmpassword |
      | krishna   | bandaru  | 9874564123 | kri124@gmail.com | 3-49     | GKPPlots | HYD  | TS    |      87541 | Test123  | test@123 | test@123        |
    #  | vijji     | VV       | 6421789964 | vvl123@gmail.com | 4-74     | Vcolony  | MAS  | TN    |      78451 | Test231  | test@456 |                 |
